                ...
                <Dialog.Panel className="w-[80vw] lg:w-[60vw] max-h-[80%] max-w-screen transform overflow-hidden rounded-2xl bg-white text-center align-middle shadow-xl transition-all ">
                  {session?.user ? (
                    <>
                      ...
                      <aside className="fixed top-0 left-0 z-40 w-64 h-screen border-r bg-white space-y-8 transition-transform -translate-x-full md:translate-x-0">
                        <nav>
                    ...
                    <div className=" w-full max-w-screen relative isolate overflow-hidden bg-gray-900 px-6 pt-16 shadow-2xl sm:px-16 md:pt-24 lg:flex lg:gap-x-20 lg:px-24 lg:pt-0">
                      ...
                      <div className="mx-auto max-w-md text-center lg:mx-0 lg:flex-auto lg:py-32 lg:text-left">
                        ...
                        <p className="mt-6 text-lg leading-8 text-gray-300">
                          Empower your team with insightful billing data
